...
(For 5-7 minute submission video)

1. **Problem Statement** (30s): Show the skills gap challenge
2. **Upload Resume** (1m): Paste sample resume, run gap analysis
3. **View Results** (1m): Show match score, missing skills, certifications
4. **Generate Roadmap** (1m): Create learning plan with timelines
5. **Browse Jobs** (30s): Filter by category, view job details
6. **Mock Interview** (1m): Generate interview questions, show AI chat
7. **Fallback Demo** (30s): Disable API key, show rule-based analysis still works
8. **Run Tests** (30s): Show `pytest` passing all 9 tests
9. **Closing** (30s): Summary of architecture and future work
